...
(function(parent) {    
    ...
    var dataProvider = app.data.mackenzie,
        fetchFilteredData = function(paramFilter, searchFilter) {
            var model = parent.get('faqsViewModel'),
        ...
        faqsViewModel = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || faqsViewModel.originalItem;

                faqsViewModel.setCurrentItemByUid(dataItem.uid);
            ...
            setCurrentItemByUid: function(uid) {
                ...
                faqsViewModel.set('originalItem', itemModel);
                faqsViewModel.set('currentItem',
                    faqsViewModel.fixHierarchicalData(itemModel));
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('faqsViewModel', faqsViewModel);
        });
    } else {
        parent.set('faqsViewModel', faqsViewModel);
    }
